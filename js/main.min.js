let wordModal=document.querySelector("._word-modal"),sentenceModal=document.querySelector("._sentence-modal"),articleText=document.querySelector(".article .text");articleText&&(articleText.onmouseup=function(e){let t="";if(wordModal.style.top=e.clientY/16+"em",sentenceModal.style.top=e.clientY/16+"em",window.getSelection?t=window.getSelection().toString():document.selection&&"Control"!=document.selection.type&&(t=document.selection.createRange().text),t){if(t=t.trim(),1===t.split(" ").length){if(t=t.replace(/[!"#$%&()*+,./:;<=>?@[\]^_`{|}~]/g,""),0===t.length)return;sentenceModal.classList.remove("_active"),wordModal.classList.add("_active")}else wordModal.classList.remove("_active"),sentenceModal.classList.add("_active")}},document.addEventListener("click",e=>{e.composedPath().includes(articleText)||(sentenceModal.classList.remove("_active"),wordModal.classList.remove("_active"))}),document.addEventListener("keydown",(function(e){27==e.keyCode&&(sentenceModal.classList.remove("_active"),wordModal.classList.remove("_active"))})));
